...
~~1. 프로젝트 공통 설정 → 2. 예외 처리·응답 규칙 → 3. Flyway·MySQL → 4. 인증·사용자 → 5. 모임·관리자·모임원 명단 → 6. 권한 처리 → 7. 폴더 → 8. 장부(예산 포함)~~ **(완료, 2026-08-16)**
→ 9. 수입·지출 내역 + 승인 → 10. 증빙 파일 → 11. 대시보드·통계 → 12. 보고서 → 13. 납부 관리 → 14. 프론트 연동 QA → 15. 런칭 서버 배포
